...
export default function PurchaseOrderForm({ purchaseOrderId }: { purchaseOrderId?: string }) {
  ...
  useEffect(() => {
    ...
    const poFormData = {
      ...
      date: formatDateToInput(purchaseOrder.date),
      deliveryDate: formatDateToInput(purchaseOrder.deliveryDate),
      ...
      items: Array.isArray(purchaseOrder.items) && purchaseOrder.items.length ? 
    ...
    if (Array.isArray(purchaseOrder.attachments)) {
