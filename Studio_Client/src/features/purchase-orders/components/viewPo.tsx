        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 p-4 sm:p-6">
          <div className="mx-auto max-w-4xl">
            ...
            <Card className="overflow-hidden shadow-xl print:shadow-none bg-white">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  ...
                  <div className="text-left sm:text-right">
                    <div className="space-y-2">
                      <div>
                        <p className="text-lg font-bold text-gray-900">{po.poNumber}</p>
                        <p className="text-sm text-gray-600">PO Number</p>
                      </div>
                      <div>
                        <p className="text-lg font-bold text-gray-900">{formatShortDate(po.date)}</p>
                        <p className="text-sm text-gray-600">Date</p>
                      </div>
                      <span
                        className={`inline-block rounded-full px-3 py-1 text-xs font-semibold capitalize ${getStatusColor(po.status)}`}
                      >
                        {po.status}
                      </span>
                    </div>
              ...
              {/* Content Area */}
              <div className="p-6">
                {/* Vendor Information - Top Section like in PDF */}
                <div className="mb-8">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">VENDOR</h2>
                  <div className="space-y-2">
                    <p className="text-lg font-bold text-gray-900">{po.vendorName}</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-600">Contact Person</p>
                        <p className="font-semibold text-gray-900">{po.vendorContact}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Email</p>
                        <p className="font-semibold text-gray-900 break-all">{po.vendorEmail}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Phone</p>
                        <p className="font-semibold text-gray-900">{po.vendorPhone}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Address</p>
                        <p className="font-semibold text-gray-900">{po.vendorAddress}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {po.company && (
                  <div className="mb-8">
                    ...
                    <div className="space-y-1 rounded-lg bg-gray-50 p-4">
                      <p className="font-semibold text-gray-900">{po.company}</p>
                      <p className="text-sm text-gray-600">{po.deliveryAddress}</p>
                    </div>
                  </div>
                )}
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="border-b-2 border-gray-900 bg-gray-100">
                          ...
                          <th className="px-4 py-3 text-left text-xs font-bold uppercase text-gray-900">ITEM DESCRIPTION</th>
                          <th className="px-4 py-3 text-left text-xs font-bold uppercase text-gray-900">BOQ CODE</th>
                ...
                {/* Terms & Conditions - Matching PDF */}
                <div className="mb-8">
                  <h3 className="text-sm font-bold uppercase text-gray-700 mb-3">TERMS & CONDITIONS</h3>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p>1. Please send invoice and delivery note with shipment.</p>
                    <p>2. Payment terms: Net 30 days from receipt of invoice.</p>
                    <p>3. Delivery to site address as specified by project manager.</p>
                    <p>4. All items must meet specified quality standards and be properly certified.</p>
                    <p>5. Supplier must notify immediately of any delays or issues with delivery.</p>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-300 pt-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-sm font-bold uppercase text-gray-700 mb-4">VENDOR ACKNOWLEDGMENT</h3>
                    ...
                    <div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <p className="text-sm text-gray-600 mb-1">Date</p>
                          <p className="font-semibold text-gray-900">{formatShortDate(po.date)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
